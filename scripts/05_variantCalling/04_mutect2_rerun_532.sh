#!/bin/bash
#SBATCH --job-name=mutect2_532
#SBATCH --output=/scratch/sballas/ISG5312FinalProject/scripts/05_variantCalling/mutect2_532_%j.out
#SBATCH --error=/scratch/sballas/ISG5312FinalProject/scripts/05_variantCalling/mutect2_532_%j.err
#SBATCH --ntasks=1
