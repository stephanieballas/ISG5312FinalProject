...
#SBATCH --output=scripts/05_variantCalling/mutect2_%A_%a.out
#SBATCH --error=scripts/05_variantCalling/mutect2_%A_%a.err
#SBATCH --ntasks=1
...
gatk Mutect2 \
    -R ${REF} \
    -I ${BAMDIR}/${TUMOR}.bqsr.bam  -tumor  ${TUMOR} \
    -I ${BAMDIR}/${NORMAL}.bqsr.bam -normal ${NORMAL} \
