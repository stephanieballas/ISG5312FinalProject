...
#SBATCH --output=/scratch/sballas/ISG5312FinalProject/scripts/06_filteringAnnotating/filter_%A_%a.out
#SBATCH --error=/scratch/sballas/ISG5312FinalProject/scripts/06_filteringAnnotating/filter_%A_%a.err
#SBATCH --ntasks=1
